...
" placeholderspolyfill";b||o(f);f.setAttribute("data-currentplaceholder",c)}}var q="hidden datetime date month week time datetime-local range color checkbox radio file submit image reset button".split(" "),k={live:!1,hideOnFocus:!1},u=[37,38,39,40],l;return{init:function(a){var d,e,i;if("undefined"===typeof document.createElement("input").placeholder){for(d in a)a.hasOwnProperty(d)&&(k[d]=a[d]);a=document.createElement("style");a.type="text/css";d=document.createTextNode(".placeholderspolyfill { color:#999 !important; }");
