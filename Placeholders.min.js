...
" placeholderspolyfill";b||o(f);f.setAttribute("data-currentplaceholder",c)}}var q="text search url tel email password number".split(" "),k={live:!1,hideOnFocus:!1},u=[37,38,39,40],l;return{init:function(a){var d,e,i;if("undefined"===typeof document.createElement("input").placeholder){for(d in a)a.hasOwnProperty(d)&&(k[d]=a[d]);a=document.createElement("style");a.type="text/css";d=document.createTextNode(".placeholderspolyfill { color:#999 !important; }");a.styleSheet?a.styleSheet.cssText=d.nodeValue:
a.appendChild(d);document.getElementsByTagName("head")[0].appendChild(a);Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){e=b||0;for(i=this.length;e<i;e+=1)if(this[e]===a)return e;return-1});Function.prototype.bind||(Function.prototype.bind=function(a){if(typeof this!=="function")throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable");var b=Array.prototype.slice.call(arguments,1),d=this,c=function(){},e=function(){return d.apply(this instanceof c?
this:a,b.concat(Array.prototype.slice.call(arguments)))};c.prototype=this.prototype;e.prototype=new c;return e});a=document.getElementsByTagName("input");d=document.getElementsByTagName("textarea");var g=a.length,f=g+d.length,b,c,h;for(b=0;b<f;b+=1)if(c=b<g?a[b]:d[b-g],h=c.getAttribute("placeholder"),-1<q.indexOf(c.type)&&h){c.setAttribute("data-currentplaceholder",h);if(""===c.value||c.value===h)c.className+=" placeholderspolyfill",c.value=h;c.form&&(h=c.form,h.getAttribute("data-placeholdersubmit")||
(j(h,"submit",s),h.setAttribute("data-placeholdersubmit","true")));o(c)}k.live&&setInterval(p,100);return!0}return!1},refresh:p}}();