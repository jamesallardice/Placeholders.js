(function () {
    ...
    var validTypes = [
        ...
        liveUpdates, styleElem, styleRules, placeholder, inputs, textareas, form, elem, len, i;
    ...
    if (test.placeholder === void 0) {
        ...
        // Get any settings declared as data-* attributes on the root element (currently the only option is whether to auto-update)
